...
export default function Home() {
  const technologies = [
    { src: java, alt: "Java", details: "Java: Write once, run anywhere." },
    {
      ...
      alt: "C#",
      details:
        "C#: Capture-Codemodule-MX: network of custom code modules built to handle intake and processing of mortgage documents. I spear-headed the clean-code innitiatve to bring this large repository",
    },
    {
      src: ts,
      alt: "TypeScript",
